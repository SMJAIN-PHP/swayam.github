                           ...
                           <div class="full white_shd">
                              ...
                              <div class="full padding_infor_info">
                                 <ul class="payment_option">
                                    <li><img src="<?php echo url('admin/images/layout_img/visa.png ')?>" alt="#" /></li>
                                    <li><img src="<?php echo url('admin/images/layout_img/mastercard.png ')?>" alt="#" /></li>
                                    <li><img src="<?php echo url('admin/images/layout_img/american-express.png ')?>" alt="#" /></li>
                                    <li><img src="<?php echo url('admin/images/layout_img/paypal.png ')?>" alt="#" /></li>
                                 </ul>
