...
<html lang="en">
   <head>
      ...
      <!-- site icon -->
      <link rel="icon" href="<?php echo url('admin/fevicon.png ')?>" type="image/png" />
      <!-- bootstrap css -->
      ...
      <!-- calendar file css -->
      <link rel="stylesheet" href="<?php echo url('admin/js/semantic.min.css')?>" />
      <!--[if lt IE 9]>
            ...
            <div class="center verticle_center full_height">
               <div class="login_section">
                  <div class="logo_login">
                     <div class="center">
                        <img width="210" src="<?php echo url('admin/images/logo/logo.png')?>" alt="#" />
                     </div>
                  </div>
                     ...
                     <form action="{{url('/admin_auth_login')}}"  method="post">
                        ...
                        <fieldset>
                           ...
                           <div class="field margin_0">
                              <label class="label_field hidden">hidden label</label>
                              <button name="submit" class="main_bt">Login</button>
                           </div>
                        </fieldset>
                     </form>
                  </div>
