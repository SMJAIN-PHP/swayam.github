                     ...
                     <div class="row column1">
                           ...
                           <div class="full white_shd margin_bottom_30">
                              <div class="info_people">
                                 <div class="p_info_img">
                                    <img src="<?php echo url('admin/images/layout_img/msg2.png ')?>" alt="#" />
                                 </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="full white_shd margin_bottom_30">
                              <div class="info_people">
                                 <div class="p_info_img">
                                    <img src="<?php echo url('admin/images/layout_img/msg3.png ')?>" alt="#" />
                                 </div>
                                 <div class="user_info_cont">
                                    <h4>David</h4>
                                    <p>developer@gmail.com</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="full white_shd margin_bottom_30">
                              <div class="info_people">
                                 <div class="p_info_img">
                                    <img src="<?php echo url('admin/images/layout_img/msg4.png ')?>" alt="#" />
                                 </div>
                                 <div class="user_info_cont">
                                    <h4>John</h4>
                                    <p>developer@gmail.com</p>
                                    ...
                                    <div class="col-md-12">
                                       <div class="msg_section">
                                          <div class="msg_list_main">
                                             <ul class="msg_list">
                                                <li>
                                                   <span><img src="<?php echo url('admin/images/layout_img/msg2.png ')?>" class="img-responsive" alt="#" /></span>
                                                   <span>
                                                ...
                                                <li>
                                                   <span><img src="<?php echo url('admin/images/layout_img/msg3.png ')?>" class="img-responsive" alt="#" /></span>
                                                   <span>
                                                   <span class="name_user">John Smith</span>
