<!-- Footer Start -->
    ...
    <script src="<?php echo url('website/https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js')?>"></script>
    <script src="<?php echo url('website/https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js')?>"></script>
