...
<head>
    ...
    <title>Arias - Account Login</title>
    <style>
        ...
        /* --- New Background Shimmer Animation Keyframes --- */
        ...
        body {
            ...
            /* FIX: Animated Background Gradient (Shimmering Water Effect) */
            background-image: 
                linear-gradient(135deg, var(--color-dark-bg) 0%, rgba(0, 194, 233, 0.5) 20%, var(--color-dark-bg) 40%, rgba(0, 194, 233, 0.5) 60%, var(--color-dark-bg) 100%);
        ...
        /* Main Card Structure */
        .auth-card {
            /* FIX: Subtle transparency to let the animated background show through */
...
<body>
    ...
    <!-- Removed the complex .background-animation div as the effect is now applied to the body -->

    <div class="auth-card" id="login-page">
        <h2>LOGIN</h2>

        <form class="auth-form" action="{{url('/auth_login')}}"  method="post">
            @csrf
        ...
        <p class="switch-link-group">
            Don't have an account? <a href="web_signup">Sign Up Now</a>
        </p>
    </div>
