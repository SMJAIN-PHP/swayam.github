...
<div class="card profile-card text-center">
  <div class="card-header bg-primary text-white">
   ...
   <img src="assets/images/admin/<?php echo $fetch->image;?>" alt="Profile Image" class="profile-img mx-auto">
    <div class="mt-2">
      <h6 >Profile Photo </h6>
</div>
  </div>
  ...
  <div class="card-body px-3">
    <form id="profileForm">
      <div class="mb-2 text-start">
       <h6 class="form-control">ADMIN-ID : <?php echo $fetch->id?> </h6>
      </div>
      <div class="mb-2 text-start">
         <h6 class="form-control">NAME : <?php echo $fetch->name?> </h6>
      </div>
      <div class="mb-2 text-start">
